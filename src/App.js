...
function App() {
  ...
  return (
    <div className='App'>
      ...
      />
        <Router />
      <div class='dark-mode-container ' onClick={toggleTheme}>
        <div class='circle'></div>
        <div
          class={`semi-circle light-mode ${
            theme === "theme-light" ? "show" : "hide"
          }`}
        ></div>
        <div
          class={`semi-circle dark-mode ${
            theme === "theme-dark" ? "show" : "hide"
          }`}
        ></div>
      </div>
