  ...
  <div id='contact' className='contact-container'>
     <div class="inner">
            <div className="contact-icon">
              ...
              >
                <GrLinkedin size={45} className='contact-react-icon'/>
              </a>
            </div>
            <div className="contact-icon ">
              <a
                ...
                className='contact-medium'
              >
                <CgInstagram size={45} className='contact-react-icon'/>
              </a>
            </div>
            <div className="contact-icon">
              <a
                ...
                className='contact-medium'
              >
                <GrGithub size={45} className='contact-react-icon' />
              </a>
            </div>
            <div className="contact-icon">
              <a
                ...
                className='contact-medium'
              >
                <TbBrandUpwork size={45} className='contact-react-icon'/>
              </a>
            </div>
        </div>
      </div>
