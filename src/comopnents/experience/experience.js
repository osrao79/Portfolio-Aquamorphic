        ...
        <div className='inner timeline'>
          <div className="container">
            <div className='header'>
              ...
              <h3 className='title c'>
                <a href="https://www.newtonschool.co/about-us" target="_blank" rel="noreferrer" >Newton School</a>
              </h3>
            </div>
          ...
          <div className="container2">
            <div className='header'>
              ...
              <h3 className='title c'>
              <a href="https://www.classicinformatics.com/" target="_blank" rel="noreferrer">Classic Informatics</a>
              </h3>
            </div>
